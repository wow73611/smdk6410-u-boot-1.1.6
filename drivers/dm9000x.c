...
#define dm9000_Tacc	(0xf)	// 14clk	access cycle
#define dm9000_Tcoh	(0x0)	// 1clk		chip selection hold
#define dm9000_Tcah	(0x4)	// 4clk		address holding time
...
//+ add by  ach for dm9000 20100907
...
dm9000_probe(void)
{
	...
	SROM_BC4_REG = ((dm9000_Tacs<<28)+(dm9000_Tcos<<24)+(dm9000_Tacc<<16)+(dm9000_Tcoh<<12)+(dm9000_Tcah<<8)+(dm9000_Tacp<<4)+(dm9000_PMC));
	/**************************end  ----******************************/
...
/*********************************modify by ach***********************************/
	...
	for (i = 0; i < 6; i++)
		...
		((u16 *) bd->bi_enetaddr)[i] = default_enetaddr[i];
#endif
/********************************end by ach******************************************/
...
eth_send(volatile void *packet, int length)
{
	...
	DM9000_iow(DM9000_IMR, IMR_PAR);    //ach add
