...
#define dm9000_Tacc	(0xd)	// 14clk	access cycle
...
static void dm9000ae_nc5_pre_init(void)
{
	SROM_BW_REG &= ~(0xf << 20);
	SROM_BW_REG |= (1<<23) | (1<<22) | (1<<20);
	SROM_BC5_REG = ((dm9000_Tacs<<28)+(dm9000_Tcos<<24)+(dm9000_Tacc<<16)+(dm9000_Tcoh<<12)+(dm9000_Tah<<8)+(dm9000_Tacp<<4)+(dm9000_PMC));
}

static void dm9000ae_nc4_pre_init(void)
{
	SROM_BW_REG &= ~(0xf << 16);
	SROM_BW_REG |= (1<<19) | (1<<18) | (1<<16);
	SROM_BC4_REG = ((dm9000_Tacs<<28)+(dm9000_Tcos<<24)+(dm9000_Tacc<<16)+(dm9000_Tcoh<<12)+(dm9000_Tah<<8)+(dm9000_Tacp<<4)+(dm9000_PMC));
}
...
int board_init(void)
{
	...
	//dm9000ae_nc5_pre_init();
	dm9000ae_nc4_pre_init();
#else
	//cs8900_pre_init();
#endif
