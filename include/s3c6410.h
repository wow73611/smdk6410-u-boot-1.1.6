...
#define S3C_SPCON	   (ELFIN_GPIO_BASE+0x1a0)
#define S3C_SPONSLP	   (ELFIN_GPIO_BASE+0x880)
#define S3C_SLPEN	   (ELFIN_GPIO_BASE+0x934)
/*
 * Bus Matrix
 */
 ...
 *LCD CONTROLLER
 */
#define S3C_LCDREG(x)   (x + ELFIN_LCD_BASE)
...
/*HOST IF registers */
/* Host I/F A - */
#define  S3C_HOSTIFBREG(x)  (0x74100000 + x)
